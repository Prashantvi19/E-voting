...
<div class="container-fluid position-relative mx-1 d-inline-block text-center " style="overflow:scroll; overflow:hidden; padding-right: 13rem !important; ">
    <h1 class="m-1">OVS Admin Deactivated</h1>
    <div class="row bg-light h-100 w-100">
        <div class="ps-1 col-lg-12">
            <div class="bg-light rounded h-100 table-responsive ">
                <?php
                include("../../controller/database.php");
                $query_org = "SELECT `unic_id`, `name`, `email`, `mobile_number`, `deactivated_by_OVS`,`deactivated_date`, `create_date`, `created_by_id` FROM `ovs_admin` WHERE `user_status`= 0";
                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        <thead>
                            <tr>
                                ...
                                <th scope="col">Deactivate By OVS ID</th>
                        ...
                        <tbody>
                            <?php foreach ($insert as $row) { ?>
                                <tr>
                                    ...
                                    <td><?php echo $row['deactivated_date']; ?></td>
                                    <td><?php echo $row['deactivated_by_OVS']; ?></td>
