        ...
        <div class="row g-5">
            ...
            <div class="col-lg-6 wow slideInUp" data-wow-delay="0.3s" style="visibility: visible; animation-delay: 0.3s; animation-name: slideInUp;">
                <form>
                    <div class="row g-3">
                        <div class="col-md-6">
                            <input type="email" class="form-control border-0 bg-light px-4" placeholder="Old E-mail" style="height: 55px;">
                        </div>
                        <div class="col-md-6">
                            <input type="number" class="form-control border-0 bg-light px-4" placeholder="Mobile Number" style="height: 55px;">
                        </div>
                        <div class="col-3">
                        ...
                        <div class="col-12">
                            <input type="text" class="form-control border-0 bg-light px-4" placeholder="New E-mail" style="height: 55px;">
                        </div>
                        <div class="col-12">
