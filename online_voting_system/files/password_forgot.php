        ...
        <div class="col-lg-3 wow slideInUp" data-wow-delay="0.6s" style="visibility: visible; animation-delay: 0.6s; animation-name: slideInUp;">
            ...
            <div class="col-lg-6 wow slideInUp" data-wow-delay="0.3s" style="visibility: visible; animation-delay: 0.3s; animation-name: slideInUp;">
                <form>
                    <div class="row g-3">
                        <div class="col-md-12">
                            <input type="text" class="form-control border-0 bg-light px-4" placeholder="Mobile Number/Email Address" style="height: 55px;">
                        </div>
                        <div class="col-3">
                            <button class="btn btn-primary w-100 py-3" type="submit">Send OTP</button>
                        </div>
                        <div class="col-md-9">
                            <input type="email" class="form-control border-0 bg-light px-4" placeholder="OTP" style="height: 55px;">
                        </div>
                        <div class="col-12">
